...
namespace CNTKLibraryCSEvalExamples
{
    ...
    {
        static List<string> Labels = new List<string> { "airplane", "automobile", "bird", "cat", "deer", "dog", "frog", "horse", "ship", "truck" };
        ...
        //public static void EvaluationSingleImage2(DeviceDescriptor device)
        //{
        //    try
        //    {
        //        Console.WriteLine("\n===== Evaluate single image =====");
        ...
        //        // Load the model.
        //        // The model resnet20_159.dnn is trained by <CNTK>/Examples/Image/Classification/ResNet/Python/Models/TrainResNet_CIFAR10.py
        //        // Please see README.md in <CNTK>/Examples/Image/Classification/ResNet about how to train the model.
        //        string modelFilePath = "resnet20_159.dnn";
        //        ThrowIfFileNotExist(modelFilePath, string.Format("Error: The model '{0}' does not exist. Please follow instructions in README.md in <CNTK>/Examples/Image/Classification/ResNet to create the model.", modelFilePath));
        //        Function modelFunc = Function.Load(modelFilePath, device);
        ...
        //        IList<Variable> inputVars = modelFunc.Inputs;

        //        string sampleImage = "00003.png";
        //        ThrowIfFileNotExist(sampleImage, string.Format("Error: The sample image '{0}' does not exist. Please see README.md in <CNTK>/Examples/Image/DataSets/CIFAR-10 about how to download the CIFAR-10 dataset.", sampleImage));
        //        Bitmap bmp = new Bitmap(Bitmap.FromFile(sampleImage));
        ...
        //        int count = 0;
        //        foreach (Variable i in inputVars)
        //        {
        //            if(count == 19)
        //            {
        //                var test = "test";
        ...
        //            if (inputDataMap.ContainsKey(i))
        //                continue;

        //            if (i.Shape.Dimensions == null | i.Shape.Dimensions.Count > 2 | i.Shape.Dimensions.Count < 2)
        //                continue;

        //            var width = i.Shape.Dimensions[0];
        //            var height = i.Shape.Dimensions[1];

        //            var resized = bmp.Resize((int)width, (int)height, true);
        //            List<float> resizedCHW = resized.ParallelExtractCHW();
        //            if (resizedCHW.Count % i.Shape.TotalSize == 0)
        //            {
        //                //if (i.Shape.TotalSize == resizedCHW.Count)
        //                //{
        //                var inputVal = Value.CreateBatch(i.Shape, resizedCHW, device);
        //                inputDataMap.Add(i, inputVal);
        //                //}
        //            }
        //            count++;
        //            Console.WriteLine(count.ToString());
        //        }
        //        //foreach(Variable i in outputVars)
        //        //{
        //        //}
        //        Variable outputVar = modelFunc.Output;
        //        outputDataMap.Add(outputVar, null);
        ...
        internal static void PrintOutput<T>(int sampleSize, IList<IList<T>> outputBuffer)
        {
            ...
            foreach (var seq in outputBuffer)
            {
                ...
                {
                    Console.Write(Labels[labelCount] + "  " );
                    labelCount++;
                    if(labelCount > 9)
                    {
                        labelCount = 0;
                    ...
                    Console.Write(Convert.ToDouble(element)  * 100);
                    if (i % outputSampleSize == 0)
                    {
                        Console.WriteLine(".");
                        sampleNo++;
